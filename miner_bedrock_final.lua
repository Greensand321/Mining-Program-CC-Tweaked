-- miner_bedrock_final.lua
-- Turtle miner with depth limit (set_depth), bedrock detection, inventory dumping, manual-complete, and auto-resume.
...
local function isBedrockBelow()
  ...
  return string.find(name, "bedrock") ~= nil
end
...
local function mineShaft(task)
  ...
  while true do
    ...
    if isBedrockBelow() then
      print("Bedrock detected below at depth " .. depth .. ", ending shaft.")
      break
    end
